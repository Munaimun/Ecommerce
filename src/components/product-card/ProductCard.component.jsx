  ...
  return (
    ...
    <div className="relative group bg-white border rounded-xl shadow-lg p-6">
      ...
      <div className="absolute sm:top-48 left-0 right-0 bottom-0 flex justify-center items-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        <Button className="group relative min-h-[50px] w-40 overflow-hidden border border-black bg-black text-white shadow-2xl transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-gray-500 before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-gray-500 after:duration-500 hover:bg-gray-600 hover:text-white hover:before:h-full hover:after:h-full">
